...
folder_path = r'C:\Users\rayde\Downloads\umasudfu\videos'

# Get the list of image files
image_files = list_image_files(folder_path)

# Define the path for the output TXT file
txt_file_path = 'imgs.txt'

# Write the formatted list to a TXT file
with open(txt_file_path, 'w') as txt_file:
    for image_file in image_files:
        line = f'<video src="videos/{image_file}" width="300" height="300" controls></video>\n'
        txt_file.write(line)
